package com.example.definelabsassignment
...
object Utils {
    ...
    fun generateProgressDialog(context: Context?): Dialog? {
        val pDialog = Dialog(context!!, com.example.definelabsassignment.R.style.ProgressTheme)
        pDialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
        val view: View =
            LayoutInflater.from(context)
                .inflate(com.example.definelabsassignment.R.layout.progress_layout, null)
